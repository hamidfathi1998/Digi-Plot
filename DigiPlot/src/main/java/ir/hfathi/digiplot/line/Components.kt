...
data class LinePlot(
    ...
    data class Line(
        ...
        val maxMinLabel: MaxMinLabel? = null,
        val lineShadowAlpha : Float = 0.2f
    )
    ...
    data class Connection(
        ...
        val pathEffect: PathEffect? = PathEffect.cornerPathEffect(10f),
        val colorFilter: ColorFilter? = null,
        val blendMode: BlendMode = DrawScope.DefaultBlendMode,
        val draw: DrawScope.(Offset, Offset,Float) -> Unit = { start, end , alpha->
            drawLine(
                color,
                start,
                end,
    ...
    data class Highlight(
        ...
        val borderRadius: Dp = (0.3).dp,
        val borderEnable: Boolean = false,
        val radius: Dp = 6.dp,
        val alpha: Float = 1.0f,
        val style: DrawStyle = Fill,
        val colorFilter: ColorFilter? = null,
    ...
    data class MaxMinLabel(
        val paint: Paint,
        val maxLabelXY: Pair<Float, Float>,
        val minLabelXY: Pair<Float, Float>,
        val draw: DrawScope.(String, Float, Float) -> Unit = { value, xOffset, yOffset ->
